...
%doc %{_mandir}/man*/*.*
%{prefix}/lib/g15daemon/%{version}/plugins/*.so
%{prefix}/lib/g15daemon/%{version}/plugins/*.la
%{prefix}/lib/g15daemon/%{version}/plugins/*.a
%{prefix}/sbin/*
%{prefix}/share/g15daemon/splash/g15logo2.wbmp
